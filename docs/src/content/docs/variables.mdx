...
| --va-color-foreground    | light-dark(#29353d, #b3ccd6)                                                   |
| --va-color-background    | light-dark(#f3f5f7, #2a303c)                                                   |
...
| --va-surface-primary-alt | color-mix(in srgb, var(--va-color-background) 80%, var(--va-color-foreground)) |
