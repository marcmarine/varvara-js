...
| `--va-icons-stroke-width` | `var(--va-border-width)`                              |
...
| `--va-foreground-color-muted`   | `color-mix(in srgb, var(--va-foreground-color-default) 20%, var(--va-background-color-default))` |
...
| `--va-background-color-hover`   | `color-mix(in srgb, var(--va-foreground-color-default) 5%, var(--va-background-color-default))` |
...
| CSS Variable           | Default Value                               |
| ---------------------- | ------------------------------------------- |
| `--va-font-family-default` | `'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif`                                         |
| `--va-font-family-headings`    | `'Segoe UI', Tahoma, Geneva, Verdana, sans-serif`  |
