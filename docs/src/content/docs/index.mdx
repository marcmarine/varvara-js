...
**Varvara CSS** is an open-source library of customizable web components implemented using simple class names, easily tailored with CSS Variables. You can use it alongside Tailwind CSS and with any JavaScript framework.
