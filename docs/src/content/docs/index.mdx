...
**Varvara CSS** is a toolkit that enhances your project with flexible building blocks. These pre-designed components can be easily implemented and customized using simple class names in your HTML. You can use it alongside Tailwind CSS and with any JavaScript framework.
...
<Code
  code={`@import 'varvara-css/variables';
